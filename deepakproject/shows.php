...
session_start();
        ...
        $k=$_SESSION['username'];
     $sql = " INSERT INTO `movieproject`.`shows`(`username`,`show_date`,`show_type`,`show_movies`,`dt`)
    VALUES ('$k','$show_date','$show_type','$show_movies',current_timestamp())";
    ...
    if (isset($_POST['clear'])) {
      $k=$_SESSION['username'];
     $sqlc="DELETE FROM `movieproject`.`shows` where username='".$k."'";
