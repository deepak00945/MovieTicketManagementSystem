...
session_start();
       ...
       $k= $_SESSION['username'];
        ...
        $sqld="INSERT INTO `movieproject`.`theatre`(`username`,`theatre_place`,`theatre_name`) VALUES ('$k','$theatre_place','$theatre_name')";
    ...
    if (isset($_POST['clear'])) {
        $k=$_SESSION['username'];
       $sqlc="DELETE FROM `movieproject`.`userinfo` where username='".$k."'";
