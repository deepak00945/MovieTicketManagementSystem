...
(t.username like '%$searchq%' and ti.username like '%$searchq%' and u.username like '%$searchq%' and m.username like '%$searchq%' and s.username like '%$searchq%')";
...
if (isset($_POST['print'])) {
    ...
    $karthik = $_SESSION['username'];
    $kar = "SELECT movie_name,show_date,no_of_tickets,totalcost,yrclass,theatre_name,price,theatre_place FROM moviebook as m,tickets as ti,shows as s,theatre as t where (t.username='$karthik'and u.username='$karthik' and ti.username='$karthik'and s.username='$karthik' and m.username='$karthik') ";
    $result1 = mysqli_query($conn, $kar);
    $total = mysqli_num_rows($result1);
