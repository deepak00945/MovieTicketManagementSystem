...
<body>
  ...
  <div id="main">
    <span style="font-size:30px;cursor:pointer;color:red;" onclick="openNav()">&#9776; HOME</span>

    <div class="gallery">
  
        <div><img src="addMovieBackground.jpg" alt="1screen"></div>
        <div><img src="bg_spiderman.png" alt="2screen"></div>
        <div><img src="pop.jpg" alt="3screen"></div>
        <div><img src="seat.jpg" alt="4screen"></div>
        <div><img src="theatre.jpg" alt="5screen"></div>
        <div><img src="popcorn.jpg" alt="6screen"></div>
        <div><img src="d.jpg" alt="7screen"></div>
        <div><img src="kgf.jpg" alt="8screen"></div>
        <div><img src="screen.jpg" alt="9screen"></div>
        <div><img src="new.jpg" alt="10screen"></div>
        <div><img src="showtime.png" alt="11screen"></div>
        <div><img src="thor.jpg" alt="12screen"></div>
        <div>
    </div>
  </div>
