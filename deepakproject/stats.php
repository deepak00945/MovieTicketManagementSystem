        ...
        <table>
            ...
            if (isset($_POST['cheker'])) {
               ...
               // $k = $_SESSION['username'];
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['theatre_name'] . "</td><td>" . $sa['theatre_place'] . "</td></tr>";
                    }
            ...
            if (isset($_POST['cheq'])) {
               ...
               // $k = $_SESSION['username'];
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['movie_name'] . "</td><td>" . $sa['movie_language'] . "</td><td>" . $sa['avg(rating)'] . "</td></tr>";
                    }
            ...
            if (isset($_POST['cheque'])) {
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['fname'] . "</td><td>" . $sa['lname'] . "</td><td>" . $sa['phone'] . "</td><td>" . $sa['email'] . "</td></tr>";
                    }
            ...
            if (isset($_POST['report5'])) {
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['yrclass'] . "</td><td>" . $sa['count( yrclass)'];
                    }
                }
            }
            if (isset($_POST['report6'])) {
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['movie_language'] . "</td><td>" . $sa['count( movie_language)'];
                    }
                }
            }
            if (isset($_POST['report4'])) {
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['movie_name'] . "</td><td>" . $sa['count(movie_name)'];
                    }
                }
            }
            ...
            if (isset($_POST['report'])) {
                error_reporting(0);
                $k = $_SESSION['username'];
                $kar = "SELECT shows.show_date,shows.show_movies,theatre.theatre_name,theatre.theatre_place from shows inner join theatre on theatre.username=shows.username  where show_date between '2022-01-25'and '2022-02-25' order by show_date";
                $result1 = mysqli_query($conn, $kar);
                $total = mysqli_num_rows($result1);
                echo "<th> movie </th>" . " " . "<th> theatre name </th>" . " " . "<th> theatre place </th>" . " " . "<th> show-date </th>";
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['show_movies'] . "</td><td>" . $sa['theatre_name'] . "</td><td>" . $sa['theatre_place'] . "</td><td>" . $sa['show_date'] . "</td><td>";
                    }
                }
            }
            if (isset($_POST['report3'])) {
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['fname'] . "</td><td>" . $sa['lname'] . "</td><td>" . $sa['movie_name'] . "</td><td>" . $sa['rating'] . "</td><td>";
                    }
                }
            }
            if (!$conn) {
            ...
            if (isset($_POST['report2'])) {
                ...
                if ($total != 0) {
                    while ($sa = mysqli_fetch_assoc($result1)) {
                        echo "<tr><td>" . $sa['movie_name'] . "</td><td>" . $sa['rating'] . "</td><td>";
                    }
                }
            }
            ?>
